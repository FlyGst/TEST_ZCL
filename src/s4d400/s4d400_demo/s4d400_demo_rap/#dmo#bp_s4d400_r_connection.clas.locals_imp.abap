...
CLASS LCL_HANDLER IMPLEMENTATION.
 ...
 METHOD CheckSemanticKey.
    ...
    READ ENTITIES OF /DMO/S4D400_r_connection IN LOCAL MODE
           ENTITY Connection
  ...
  METHOD GetCities.
    ...
    DATA connections_upd TYPE TABLE FOR UPDATE /DMO/S4D400_r_connection.

    connections_upd = CORRESPONDING #( connections ).

    MODIFY ENTITIES OF /DMO/S4D400_r_connection IN LOCAL MODE
             ENTITY Connection
             UPDATE
