...
CLASS lcl_generator_carrier DEFINITION INHERITING FROM lcl_generator.
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_tabname TYPE tabname VALUE '/DMO/CARRIER'.
    ...
    DATA carriers TYPE TABLE OF /dmo/carrier READ-ONLY.
...
CLASS lcl_generator_connection DEFINITION INHERITING FROM lcl_generator.
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_tabname TYPE tabname VALUE '/DMO/CONNECTION'.
    ...
    DATA connections TYPE TABLE OF /dmo/connection READ-ONLY.
